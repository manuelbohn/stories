...
ggplot()+
  ...
  labs(x = "Age", y="Probability of producing a narrative component")+
  theme(legend.position = c(0.1, 0.35), legend.background = element_rect(colour = "black", size = 0.5, linetype = "solid"))

```

```{r}
ggsave("../visuals/fig8.png", height = 8, width = 12, scale = 1)
```
